...
function Homepage() {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 h-64 bg-white dark:bg-black p-10'>
            ...
            <div className="flex justify-center items-center"><img src={scrumBoard} alt="image" className='size-[450px]' /></div>
        </div>
    )
}
